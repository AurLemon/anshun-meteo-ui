<template>
  <div class="timeline-demo">
    ...
    <!-- 自定义步长 -->
    <section class="demo-section">
      <h2>自定义步长 (拖动5分钟，刻度30分钟)</h2>
      <p>当前时间: {{ formatTime(customStepValue) }}</p>
      <p class="demo-tip">拖动时间指针按5分钟步长对齐，时间轴刻度按30分钟显示</p>
...
console.log('pointValue:', pointValue.value)
console.log('rangeValue:', rangeValue.value)
console.log('TimeUtils.now():', TimeUtils.now())
console.log('TimeUtils.startOfToday():', TimeUtils.startOfToday())
console.log('TimeUtils.endOfToday():', TimeUtils.endOfToday())
